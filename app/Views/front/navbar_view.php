    ...
    <div class="container-fluid">
        ...
        <?php if (session()->perfil_id == 1) : ?>
            <div class="btn btn-info active btnUser tbn-sm">
                <a herf="">Admin: <?php echo session('nombre'); ?> </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-success" href="#">Usuarios</a>
                    </li><li class="nav-item">
                        <a class="nav-link btn btn-outline-success" href="#">Contenido</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-success" href="#">Comentarios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-success" href="#">Configuración del Sitio</a>
                    </li>
                    <li class="nav-item">
        ...
        <?php elseif (session()->perfil_id == 2) : ?>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-success" href="#">Carrito</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-success" href="<?php echo base_url('logout'); ?>" tabindex="-1" aria-disabled="true">Cerrar Sesion</a>
                    </li>
